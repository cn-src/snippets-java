...
/**
 * Annotation to enable JDBC repositories. Will scan the package of the annotated configuration
...
public @interface EnableJooqJdbcRepositories {
     ...
     * attribute. Use {@link #basePackageClasses()} for a type-safe alternative to String-based
     * package names.
     */
     ...
     * annotated components. The
     * package of each class specified will be scanned. Consider creating a special no-op marker
     ...
     * candidate components from
     * everything in {@link #basePackages()} to everything in the base packages that matches the
     ...
     * to {@literal Impl}. So
     * for a repository named {@code PersonRepository} the corresponding implementation class
     * will be looked up scanning
     ...
     * be used to create repositories discovered through this annotation. Defaults to {@code
     * defaultDataAccessStrategy}.
     */
    String dataAccessStrategyRef() default "";

    /**
     * Configures the name of the {@link DataSourceTransactionManager} bean definition to be used
